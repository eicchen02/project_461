...
def main(link):
    ...
    # response = requests.get(link + "/package/byRegEx", headers=header, json={'regex': 'testRegEx'})
    # if(response.status_code == 200):
